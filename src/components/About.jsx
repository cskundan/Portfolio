      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        ...
        >
          ...
          <p
            ...
            bg-linear-to-r from-orange-900/10 to-orange-900/5 p-4 sm:p-2 rounded-xl backdrop-blur-sm ${
              darkMode ? "text-gray-300" : "text-gray-700"
            }`}
            data-aos="fade-up"
            data-aos-delay="500"
          >
            I'm <b>Kundan Kumar</b>, an MCA student and aspiring
            <b> Full Stack Developer </b> with skills in HTML, CSS, JavaScript,
            React.js, Node.js, Express.js, SQL, and MongoDB. I have built
            projects like a School Management System, focusing on CRUD
            operations and clean UI design. I enjoy solving problems using Data
            Structures & Algorithms and continuously learning new technologies.
            📍 Noida, India 📧 Open to internships and opportunities
          </p>
          {/* Stats */}
          ...
          {/* Button */}
          <button
            className={`w-full sm:w-auto border-2 border-orange-500 inline-flex items-center justify-center 
