...
const Navbar = ({ darkMode, toggleDarkMode }) => {
  ...
  return (
    <div className="flex justify-center w-full fixed z-50 mt-4">
      <motion.nav
        className={`relative w-[calc(100%-1rem)] max-w-5xl
              ...
              >
                ...
                {activeSection === item.name.toLowerCase() && (
                  <motion.div
                    ...
                    className={`absolute bottom-0 left-0 right-0 h-0.5 bg-linear-to-r ${colors.indicator}`}
                  />
                )}
              </a>
            ))}
          ...
          >
            <div className="px-4 py-3 space-y-2">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className={`block py-3 px-4 text-center font-semibold rounded-lg bg-linear-to-r ${colors.button} text-white`}
              >
                Hire Me
              </motion.a>
            </div>
